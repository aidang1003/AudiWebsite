...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron" style="background-image: url(Images/audirs7.jpg); background-size: cover; height:500px;">
        ...
        <p><a href="Account/Register" class="btn btn-primary btn-lg">Learn more &raquo;</a></p>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn btn-default" href="User/Browse">Learn more &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            <h2>Place a bid</h2>
            ...
            <p>
                <a class="btn btn-default" href="User/Bid">Learn more &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            <h2>View Bids</h2>
            ...
            <p>
                <a class="btn btn-default" href="User/ViewBids">Learn more &raquo;</a>
            </p>
        </div>
    </div>
